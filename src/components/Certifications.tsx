...
import { Award, Upload, X, Edit2, Check, Medal, Trophy } from 'lucide-react';
        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'animate-fadeIn' : 'opacity-0'}`}>
          ...
          <div className="relative">
            ...
            <div 
              ...
              className="flex gap-4 overflow-x-auto pb-4 px-8 custom-scrollbar"
            >
              {certificates.map((certificate, index) => {
                // Cycle through different certificate icons
                const iconIndex = index % 3;
                const CertIcon = [Award, Medal, Trophy][iconIndex];
                ...
                return (
                  <div
                    key={certificate.id}
                    className={`flex-shrink-0 w-64 glass-card glass-hover cursor-pointer transition-all duration-500 hover:scale-105 glow-hover p-4 ${
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center mb-3">
                      <div className={`w-12 h-12 bg-gradient-to-br ${gradientColors} rounded-lg flex items-center justify-center shadow-lg`}>
                        ...
                        {editingId === certificate.id ? (
                          <div className="flex items-center gap-1 w-full">
                            <input
                              ...
                              className="bg-white/10 border border-white/20 rounded px-2 py-1 text-xs text-center min-w-0 flex-1"
